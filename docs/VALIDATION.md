...
Exercised the OpenProver UI in the v0.1.0 local HTTP server in headless Microsoft Edge at desktop **1440 × 1000** and mobile **390 × 844** sizes. The v0.1.1 patch changes provider failover and error reporting without changing the UI:
